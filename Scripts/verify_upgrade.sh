...
PYTHON="/home/kali/Documents/Code/SECIDS-CNN/.venv_test/bin/python"
PASSED=0
FAILED=0
...
if $PYTHON -c "from UI import terminal_ui_enhanced; from Scripts import optimize_system; from Tools import progress_utils" 2>/dev/null; then
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
CONFIGS_OK=true
for file in "requirements.txt" "pyrightconfig.json" "secids_main.py" "system_integrator.py"; do
    if [ ! -f "$file" ]; then
        echo "❌ Missing: $file"
        CONFIGS_OK=false
    fi
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
if [ -d "Backups/upgrade_20260131_213231" ]; then
